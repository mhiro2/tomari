...
const en = {
  ...
  'settings.kernelState': 'Kernel sleep veto',
  'settings.kernelStateHint':
    'The actual macOS SleepDisabled flag, read independently of the switch.',
  'settings.kernelBlocked': 'Sleep blocked',
  'settings.kernelAllowed': 'Sleep allowed',
  'settings.ownership': 'Override owner',
  'settings.ownershipHint': 'Tomari clears only the lid-close override it created.',
  'settings.ownedByTomari': 'Owned by Tomari',
  'settings.notOwned': 'Not owned',
...
const ja: Record<MessageKey, string> = {
  ...
  'settings.kernelState': 'kernel のスリープ拒否',
  'settings.kernelStateHint': 'スイッチとは別に読み取った macOS の実際の SleepDisabled 状態です。',
  'settings.kernelBlocked': 'スリープ拒否中',
  'settings.kernelAllowed': 'スリープ可能',
  'settings.ownership': 'オーバーライドの所有者',
  'settings.ownershipHint': 'Tomari は自身が設定した蓋閉じ防止だけを解除します。',
  'settings.ownedByTomari': 'Tomari が所有',
  'settings.notOwned': '所有していない',
