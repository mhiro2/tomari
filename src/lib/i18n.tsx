...
const en = {
  ...
  'settings.safetyGuards': 'Safety guards',
  'settings.autoOff': 'Turn off automatically',
  'settings.autoOffHint': 'Tomari enforces the deadline even while this window is closed.',
  'settings.autoOffNever': 'Never',
  'settings.autoOff30m': 'After 30 minutes',
  'settings.autoOff1h': 'After 1 hour',
  'settings.autoOffAtTime': 'At a time…',
  'settings.endTime': 'End time',
  'settings.timeRemaining': 'Time remaining',
  'settings.acOnly': 'Only while connected to power',
  'settings.acOnlyHint': 'Turns off if AC power is disconnected.',
  'settings.lowBattery': 'At 20% battery',
  'settings.lowBatteryHint': 'Choose whether Tomari warns you or starts turning Keep Awake off.',
  'settings.lowBatteryWarn': 'Warn me',
  'settings.lowBatteryTurnOff': 'Turn off',
  'settings.noticeAcRequired': 'Connect a power adapter before turning this on.',
  'settings.noticeAcDisconnected': 'AC power was disconnected. Turning Keep Awake off.',
...
const ja: Record<MessageKey, string> = {
  ...
  'settings.safetyGuards': '安全ガード',
  'settings.autoOff': '自動的にオフ',
  'settings.autoOffHint': 'この画面を閉じていても、Tomari が終了時刻を監視します。',
  'settings.autoOffNever': 'オフにしない',
  'settings.autoOff30m': '30分後',
  'settings.autoOff1h': '1時間後',
  'settings.autoOffAtTime': '終了時刻を指定…',
  'settings.endTime': '終了時刻',
  'settings.timeRemaining': '残り時間',
  'settings.acOnly': '電源接続中のみ有効',
  'settings.acOnlyHint': 'AC 電源を外すとスリープ防止を解除します。',
  'settings.lowBattery': 'バッテリー残量20%時',
  'settings.lowBatteryHint': '警告のみ、またはスリープ防止の自動解除を選べます。',
  'settings.lowBatteryWarn': '警告する',
  'settings.lowBatteryTurnOff': 'オフにする',
  'settings.noticeAcRequired': '電源アダプタを接続してからオンにしてください。',
  'settings.noticeAcDisconnected': 'AC 電源が外れたため、スリープ防止を解除します。',
